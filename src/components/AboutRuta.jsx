  ...
  <div className="container px-16 md:px-8 lg:px-28">
    <div className="grid grid-cols-12 justify-center">
      ...
      <div className="col-span-12 md:col-span-8 md:col-start-3 text-center">
        <h1 className="font-bold text-3xl lg:text-[45px] leading-none mb-4">Lorem ipsum dolor sit amet</h1>
        <p className="text-lg leading-6 opacity-80 mb-2">Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
      </div>
      {/* <!-- banner --> */}
      ...
      <div className="col-span-12 md:col-span-8 md:col-start-3">
        ...
        <br />
        <h4 className="text-2xl font-medium opacity-80 mb-2">The standard Lorem Ipsum</h4>
        <p className="text-[17px] leading-6 opacity-80 mb-2">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Pariatur, odio. Hic, nisi! Perspiciatis veritatis
          quibusdam esse! Corrupti aut unde neque sit alias repudiandae ratione debitis id pariatur? Nesciunt quam
          officia enim repudiandae, voluptatibus, culpa veniam sapiente sunt nisi ratione tenetur.
        ...
        >
          ...
          <p className="text-[17px] leading-6 opacity-80 mb-2">- John Doe, CEO & Founder</p>
        </blockquote>
        <br />
        <p className="text-[17px] leading-6 opacity-80 mb-2">
          Lorem ipsum dolor sit amet consectetur
          <a href="#" className="text-blue-600 underline opacity-80">adipisicing elit</a>. Pariatur, odio. Hic, nisi!
        ...
        <br />
        <h4 className="text-2xl font-medium mb-2">1914 translation by H.</h4>
        <p className="text-[17px] leading-6 opacity-80 mb-2">
        ...
        <ul className="flex justify-center items-center">
          <li>
            <a
              ...
              ><i className="fas fa-clone mr-2"></i> Copy Link</a
            >
          </li>
          <li>
            <a
