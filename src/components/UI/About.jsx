...
export const About = () => {
  return (
    <>
    <section
  class="ezy__about15 light py-14 md:py-24 bg-white dark:bg-[#0b1727] text-zinc-900 dark:text-white relative z-[1]">
  <div class="absolute top-0 left-0 right-0 bottom-0 w-[30vw] bg-blue-600 bg-opacity-30 -z-[1]"></div>
  <div class="container px-4">
    <div class="grid grid-cols-12 gap-5 items-center">
      <div class="col-span-12 lg:col-span-4">
        <div>
          <img src="https://cdn.easyfrontend.com/pictures/hero/hero-10.png" alt="" class="max-w-full h-auto" />
        </div>
      </div>
      <div class="col-span-12 md:col-span-6 lg:col-span-4">
        <div>
          <h1 class="text-3xl md:text-5xl font-bold mb-4">About Us</h1>
          <p class="opacity-75">
            ...
            testing procedures before unique process improvements.
          </p>
        </div>
      </div>
      <div class="col-span-12 md:col-span-6 lg:col-span-4">
